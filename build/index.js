...
function Edit(_ref) {
  ...
  const posts = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.useSelect)(select => {
  ...
  const allCats = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.useSelect)(select => {
